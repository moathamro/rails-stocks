...
class Profile(models.Model):
	...
	image = models.ImageField(blank=True, upload_to='profile_pics', default='profile.png')
...
class Activity(models.Model):
	user = models.ForeignKey(User, related_name='log_user', null=True,on_delete=models.SET_NULL)
